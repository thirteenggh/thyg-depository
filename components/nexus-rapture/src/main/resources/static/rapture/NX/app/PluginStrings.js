...
Ext.define(
  "NX.app.PluginStrings",
  {
    ...
    keys: {
      ...
      Header_Help_About_Tooltip: "关于 Nexus Repository Manager",
      Header_Help_Documentation_Text: "文档",
      Header_Help_Documentation_Tooltip: "产品文档",
      Header_Help_KB_Text: "知识库",
      Header_Help_KB_Tooltip: "知识库",
      Header_Help_Guides_Text: "Sonatype指南",
      Header_Help_Guides_Tooltip: "Sonatype指南",
      ...
      // About modal
      AboutWindow_Title: "关于 Nexus Repository Manager",
