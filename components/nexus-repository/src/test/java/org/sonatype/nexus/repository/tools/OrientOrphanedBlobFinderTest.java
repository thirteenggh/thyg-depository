...
import org.sonatype.nexus.repository.tools.orient.OrientOrphanedBlobFinder;
...
@Named
public class OrientOrphanedBlobFinderTest
    extends TestSupport
{
  ...
  public void setup() throws Exception {
    ...
    underTest = new OrientOrphanedBlobFinder(repositoryManager, blobStoreManager);
  }
