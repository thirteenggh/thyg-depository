...
/**
 * {@link OrientScript} entity adapter.
 *
 * @since 3.0
 */
@Named
...
public class OrientScriptEntityAdapter
    extends IterableEntityAdapter<OrientScript>
{
  ...
  public OrientScriptEntityAdapter() {
    super(DB_CLASS);
  }
  ...
  @Override
  protected OrientScript newEntity() {
    return new OrientScript();
  }

  @Override
  protected void readFields(final ODocument document, final OrientScript entity) throws Exception {
  ...
  @Override
  protected void writeFields(final ODocument document, final OrientScript entity) throws Exception {
