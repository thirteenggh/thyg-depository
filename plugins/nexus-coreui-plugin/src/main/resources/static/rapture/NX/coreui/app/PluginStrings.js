...
Ext.define(
  "NX.coreui.app.PluginStrings",
  {
    ...
    keys: {
      ...
      Licensing_LicenseAgreement_Title: "Nexus Repository Manager 许可协议",
    ...
    bundles: {
      "NX.coreui.migration.Controller": {
        Feature_Text: "升级",
        Feature_Description: "从 Nexus Repository Manager 2 升级配置和内容",
      ...
      "NX.coreui.migration.NoUpgradeHAScreen": {
        ...
        Description:
          "<p>在运行 HA-C 时，从 Nexus Repository Manager 2 升级不可用。</p>" +
          "<p>请以单节点模式运行 Nexus Repository Manager 3 以继续。</p>",
      },
      ...
      "NX.coreui.migration.ContentScreen": {
        Title: "内容",
        Description:
          "<p>您希望从 Nexus Repository Manager 2 转移哪些内容？</p>",
      ...
      "NX.coreui.migration.OverviewScreen": {
        Title: "概览",
        Description:
          "<p>此向导将帮助您从 Nexus Repository Manager 2 升级。</p>" +
          ...
          "<li>在升级成功完成之前，不建议在 Nexus Repository Manager 3 中进行任何配置更改，因为此时配置是易变的。</li>" +
