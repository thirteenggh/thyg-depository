...
public abstract class CocoapodsProxyRepositoriesApiResource
    extends AbstractProxyRepositoriesApiResource<CocoapodsProxyRepositoryApiRequest>
{
  @ApiOperation("Create Cocoapods proxy repository")
  @ApiResponses(value = {
  ...
  @Validate
  @Override
  public Response createRepository(final CocoapodsProxyRepositoryApiRequest request) {
  ...
  public boolean isApiEnabled() {
    return highAvailabilitySupportChecker.isSupported(CocoapodsFormat.NAME);
  }
}
