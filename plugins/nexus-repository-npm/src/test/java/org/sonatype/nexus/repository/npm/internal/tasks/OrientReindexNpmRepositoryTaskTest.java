...
public class OrientReindexNpmRepositoryTaskTest
    extends TestSupport
{
  ...
  OrientReindexNpmRepositoryTask underTest;
  ...
  public void setUp() throws Exception {
    ...
    underTest = new OrientReindexNpmRepositoryTask(npmPackageParser, assetEntityAdapter);
