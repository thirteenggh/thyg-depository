...
import org.sonatype.nexus.repository.rest.api.model.SimpleApiGroupDeployRepository;
...
public abstract class NpmGroupRepositoriesApiResource
    extends AbstractGroupRepositoriesApiResource<NpmGroupRepositoryApiRequest>
{
  ...
  @Validate
  @Override
  public Response createRepository(final NpmGroupRepositoryApiRequest request) {
  ...
  public Response updateRepository(
      final NpmGroupRepositoryApiRequest request,
  ...
  @RequiresAuthentication
  @Validate
  @ApiOperation(value = "Get repository", response = SimpleApiGroupDeployRepository.class)
  @Override
