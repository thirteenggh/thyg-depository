...
public abstract class NpmProxyRepositoriesApiResource
    extends AbstractProxyRepositoriesApiResource<NpmProxyRepositoryApiRequest>
{
  ...
  @Validate
  @Override
  public Response createRepository(final NpmProxyRepositoryApiRequest request) {
  ...
  @Validate
  @Override
  @ApiOperation(value = "Get repository", response = NpmProxyApiRepository.class)
