...
import static org.sonatype.nexus.repository.npm.rest.NpmProxyRepositoriesApiResourceBeta.RESOURCE_URI;
...
@Path(RESOURCE_URI)
@Deprecated
public class NpmProxyRepositoriesApiResourceBeta
    extends NpmProxyRepositoriesApiResource
{
  static final String RESOURCE_URI = RepositoriesApiResourceBeta.RESOURCE_URI + "/npm/proxy";
}
