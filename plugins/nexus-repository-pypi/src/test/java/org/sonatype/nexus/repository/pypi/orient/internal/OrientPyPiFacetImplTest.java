    ...
    extends TestSupport
{
  ...
  public void testPutPackage() throws Exception {
    ...
    when(blob.getInputStream()).thenReturn(this.getClass().getResourceAsStream("/org/sonatype/nexus/repository/pypi/internal/sample-1.2.0.tar.gz"));
