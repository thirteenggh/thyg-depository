...
{
  @ApiOperation("Create PyPI group repository")
  @ApiResponses(value = {
  ...
  @Validate
  @Override
  public Response createRepository(final PypiGroupRepositoryApiRequest request) {
    return super.createRepository(request);
  }

  @ApiOperation("Update PyPI group repository")
  @ApiResponses(value = {
  ...
  public Response updateRepository(
      final PypiGroupRepositoryApiRequest request,
