...
public abstract class PypiHostedRepositoriesApiResource
    extends AbstractHostedRepositoriesApiResource<PypiHostedRepositoryApiRequest>
{

  @ApiOperation("Create PyPI hosted repository")
  @ApiResponses(value = {
  ...
  @Validate
  @Override
  public Response createRepository(final PypiHostedRepositoryApiRequest request) {
