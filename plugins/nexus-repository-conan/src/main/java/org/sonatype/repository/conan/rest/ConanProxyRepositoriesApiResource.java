...
public abstract class ConanProxyRepositoriesApiResource
    extends AbstractProxyRepositoriesApiResource<ConanProxyRepositoryApiRequest>
{
  ...
  @Validate
  @Override
  public Response createRepository(final ConanProxyRepositoryApiRequest request) {
  ...
  public boolean isApiEnabled() {
    return highAvailabilitySupportChecker.isSupported(ConanFormat.NAME);
  }
}
