...
{
  private final OrientKeyStoreStorageManager storageManager;
  ...
  public OrientKeyStoreStorage(final OrientKeyStoreStorageManager storageManager, final String keyStoreName) {
  ...
  {
    OrientKeyStoreData entity = storageManager.load(keyStoreName);
