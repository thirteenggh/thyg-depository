...
Ext.define(
  "NX.s3blobstore.app.PluginStrings",
  {
    ...
    keys: {
      S3Blobstore_Help:
        '<em>S3 Blob 存储需要特定的权限才能通过 Nexus Repository Manager 完成完整的配置和功能支持。<a href="https://links.sonatype.com/products/nexus/blobstores/s3/docs" target="_blank">请参阅我们的文档</a>了解所需的特定权限。</em>',
